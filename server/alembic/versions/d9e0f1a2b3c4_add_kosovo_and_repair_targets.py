...
Existing facts, past puzzles and all recorded play remain untouched. SQLite and
RAG provisioning run separately at startup against the mounted data directory.
"""
