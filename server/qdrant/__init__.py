...
COUNTRYDLE_CONTEXT_LIMIT = int(os.getenv("COUNTRYDLE_CONTEXT_LIMIT", "3"))
POWIATDLE_CONTEXT_LIMIT = int(os.getenv("POWIATDLE_CONTEXT_LIMIT", "3"))
US_STATEDLE_CONTEXT_LIMIT = int(os.getenv("US_STATEDLE_CONTEXT_LIMIT", "3"))
WOJEWODZTWDLE_CONTEXT_LIMIT = int(os.getenv("WOJEWODZTWDLE_CONTEXT_LIMIT", "3"))
