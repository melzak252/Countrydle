...
export default function HomePage() {
  ...
  const games = [
    ...
    { id: 'flagdle', title: 'Flagdle', region: 'Daily Flags',
      description: 'Progressive unmasking and color matrix. Deduce the daily secret flag in 6 guesses.',
      path: '/flagdle', icon: Flag, questions: 0, guesses: 6, count: 195 },
